...
2. **[skill-linter](https://github.com/aicatalyst-team/skill-linter)** — lints skills against the agentskills.io spec (`--strict` mode)
...
You can auto-fix some skill-linter issues with `make skill-linter-fix`.
