...
.PHONY: skill-linter
skill-linter: ## Run skill-linter on skills
	@echo "Running skill-linter on skills..."
	@npx skill-linter check helpers/skills/*/ --strict

.PHONY: skill-linter-fix
skill-linter-fix: ## Auto-fix fixable skill-linter issues
	@echo "Fixing skill-linter issues..."
	@npx skill-linter check helpers/skills/*/ --fix
