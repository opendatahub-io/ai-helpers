...
def main():
    ...
    parser.add_argument("output_dir", type=str, help="Output directory for saved model")
    parser.add_argument(
        "--target_perplexity",
        type=float,
        default=3.0,
    ...
    parser.add_argument(
        ...
        default=15,
        help=(
            "Number of consecutive steps perplexity must be below target "
            "before stopping (default: 15)"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--learning_rate", type=float, default=5e-5, help="Learning rate (default: 5e-5)"
    )
    parser.add_argument(
        "--max_steps", type=int, default=1000, help="Maximum training steps (default: 1000)"
    )
    ...
    perplexity_callback = PerplexityStoppingCallback(
        target_perplexity=args.target_perplexity, consecutive_steps=args.consecutive_steps
    )
