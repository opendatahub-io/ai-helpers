...
description: >-
  Use when implementing a code fix for a Jira bug ticket. Investigates the
  codebase, evaluates fix strategy, writes code changes, adds tests where
  feasible, validates, and commits.
