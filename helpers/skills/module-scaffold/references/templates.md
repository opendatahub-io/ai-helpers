...
func SetupController(ctx context.Context, mgr manager.Manager) error {
	r, err := reconciler.NewReconciler(
		mgr,
		"<COMPONENT>",
		&<API_VERSION>.<COMPONENT_PASCAL>{},
	...
	// Actions execute sequentially; GC must be last.
	r.AddAction(renderAction)
	r.AddAction(deployAction)
	r.AddAction(gcAction)
...
import (
	...
	"github.com/opendatahub-io/odh-platform-utilities/framework/controller/actions/render"
	"github.com/opendatahub-io/odh-platform-utilities/framework/controller/types"
)

// Each action follows: func(ctx context.Context, rr *types.ReconciliationRequest) error

func renderAction(ctx context.Context, rr *types.ReconciliationRequest) error {
	// TODO: Use render.NewHelmAction() or rr.HelmCharts to render manifests.
	return nil
}

func deployAction(ctx context.Context, rr *types.ReconciliationRequest) error {
	// TODO: Use deploy.NewAction() to apply rendered resources via SSA.
	return nil
}

// gcAction MUST be the last action added to the reconciler.
func gcAction(ctx context.Context, rr *types.ReconciliationRequest) error {
	// TODO: Use gc.NewAction() to remove stale resources.
	return nil
}
```
