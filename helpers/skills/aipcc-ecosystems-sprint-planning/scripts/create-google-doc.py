...
def parse_markdown_to_requests(markdown_content):
    ...
    for item in text_map:
        ...
        # Bullets - collect them
            ...
            bullet_items.append({"start": start, "end": end, "level": nesting_level})
        ...
        # Regular paragraphs
            ...
            line.startswith("#") or line.strip().startswith("-") or line.strip().startswith("*")
        ):
            if line.strip():
                requests.append(
                    {
...
def create_google_doc(title, markdown_file):
    ...
    try:
        ...
        print("   ✓ Proper bullet nesting")
        print("   ✓ Tighter section spacing")
        print("   ✓ Clickable Jira links")
        print("   ✓ Clean layout")
