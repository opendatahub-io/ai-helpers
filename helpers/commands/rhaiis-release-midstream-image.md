...
## Name
odh-ai-helpers:rhaiis-release-midstream-image

## Synopsis
```
/rhaiis:release-midstream-image v0.14.0+rhai3 cuda  # Release CUDA image
/rhaiis:release-midstream-image v0.14.0+rhai3 rocm  # Release ROCm image
/rhaiis:release-midstream-image v0.14.0+rhai3 cpu   # Release CPU image
```
...
### Release CUDA image
```bash
/rhaiis:release-midstream-image v0.14.0+rhai3 cuda
```

### Release ROCm image
```bash
/rhaiis:release-midstream-image v0.14.0+rhai3 rocm
```

### Release CPU image
```bash
/rhaiis:release-midstream-image v0.14.0+rhai3 cpu
```
...
## See Also
- **`/rhaiis:downstream-release-status`** – Check overall release status
