...
## Name
odh-ai-helpers:rhaiis-downstream-release-status

## Synopsis
```
/rhaiis:downstream-release-status v0.14.0+rhai3      # Check specific release
/rhaiis:downstream-release-status v0.14.0+rhai3 cuda # Check specific accelerator
/rhaiis:downstream-release-status v0.14.0 all        # Check all accelerators
```
...
```bash
/rhaiis:downstream-release-status v0.14.0+rhai3
```

### Check CUDA specifically
```bash
/rhaiis:downstream-release-status v0.14.0+rhai3 cuda
```

### Full status for all accelerators
```bash
/rhaiis:downstream-release-status v0.14.0 all
```
...
## See Also
- **`/rhaiis:release-midstream-image`** – Release a vLLM container image to quay.io
